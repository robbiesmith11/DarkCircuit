...
const TERMINAL_WS_URL = 'ws://127.0.0.1:8000';
    ...
    <div className="flex h-screen bg-black">
      ...
      <div className="flex-1 p-4 overflow-auto">
        ...
        <img
          ...
          className="absolute top-1/2 left-1/2 w-[80%] max-w-4xl max-h-screen opacity-15 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0"
        />
