...
class App:
    def __init__(self):
        ...
        async def chat_completions(request: ChatRequest):
            ...
            # Create a user message from the last message in the array
            ...
            prompt = last_user_message if last_user_message else ""
            ...
            async def generate_stream():
                try:
                    # Pass both prompt and structured messages to run_agent_streaming
                    async for event in agent.run_agent_streaming(prompt, agent_messages):
